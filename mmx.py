...
botStart = time.time()
#======================================================================================
maxgie = LINE("alishjoker7@gmail.com","aliahmadi11")
...
tagadd = {
    ...
    "b": "บัญชีนี้ถูกป้องกันด้วย Self Bot By. ꧁{★ढेণढेююທ์★}꧂ ระบบได้บล็อคบัญชีคุณอัตโนมัติ >_<",
    "c":"Auto Like By. ꧁{★ढेণढेююທ์★}꧂",
